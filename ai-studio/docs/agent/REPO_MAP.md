...
- `src/AIStudio.Application/Rendering/Visuals/SceneVisualPlanner.cs`, `SceneVisualPlan.cs`, `SceneVisualEngine.cs`, `SceneAnimationTemplate.cs`, `SceneAnimationParameters.cs`, `SceneVisualEngineSelector.cs` — deterministic storyboard-to-visual planning and engine/template selection.
