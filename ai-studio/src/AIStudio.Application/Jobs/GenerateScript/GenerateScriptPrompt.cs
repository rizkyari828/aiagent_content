...
internal static class GenerateScriptPrompt
{
        ...
        StoryContextModel? storyContext = null)
    {
        ...
        builder
            ...
            .AppendLine("- The idea hook/angle, creative guidance, and beat purposes may mention sound cues, visual cues, effects, or transitions such as 'ding sound', 'sparkle effect', 'boing', 'music rises', or 'screen flashes'. Those are CONTEXT to translate, never words to narrate.")
            .AppendLine("- Translate their narrative intention into spoken words rather than narrating the cue itself; for example, instead of 'a ding sounds and a sparkle effect appears', write that the child beams as the last toy lands in place.")
            .AppendLine("- Never put camera, shot, lens, editing, acting, sound-effect, visual-effect, SFX, music, overlay, or scene-direction instructions inside openingHook, narration, or closing. Describing an event a listener can hear or see is fine ('the room suddenly goes quiet'); instructing editors or renderers is not.")
            .AppendLine()
