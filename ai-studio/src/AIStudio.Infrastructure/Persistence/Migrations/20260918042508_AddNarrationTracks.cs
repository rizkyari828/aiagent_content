...
{
    /// <inheritdoc />
    public partial class AddNarrationTracks : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "narration_tracks",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_narration_tracks", x => x.id);
                    table.CheckConstraint("ck_narration_tracks_byte_size", "byte_size >= 0");
                    table.CheckConstraint("ck_narration_tracks_content_hash", "char_length(content_hash) = 64");
                    table.ForeignKey(
                        name: "FK_narration_tracks_content_projects_content_project_id",
                        column: x => x.content_project_id,
                        principalTable: "content_projects",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_narration_tracks_jobs_source_job_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_narration_tracks_source_job_id",
                table: "narration_tracks",
                column: "source_job_id");

            migrationBuilder.CreateIndex(
                name: "ux_narration_tracks_content_project_id",
                table: "narration_tracks",
